...
import com.arvoice.databinding.ActivitySelectLeadBinding;
...
public class SelectLeadActivity extends AppCompatActivity implements LeadListAdapter.OnCardClickListener{
    private Context mContext;
    private ActivitySelectLeadBinding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding = ActivitySelectLeadBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
        mContext = this;
        apiInterface = ApiClient.getPostService().create(ApiInterface.class);
        if (getIntent() != null) {
            categoryName = getIntent().getIntExtra("templateID", -1);
    ...
    public void onCardClick(int position) {
        ...
        resultIntent.putExtra("selectedLead", contentItem);
